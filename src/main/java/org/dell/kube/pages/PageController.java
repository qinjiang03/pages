...
public class PageController {
    ...
    public ResponseEntity<Page> create(@RequestBody Page page) {
        ...
        logger.info("CREATE-INFO:Creating page with id = ");
        logger.debug("CREATE-DEBUG:Creating page with id = ");
    ...
    public ResponseEntity<List<Page>> list() {
        ...
        logger.info("READ-INFO:Fetchhing all pages with id = " );
        logger.debug("READ-DEBUG:Fetching all page with id = " );
